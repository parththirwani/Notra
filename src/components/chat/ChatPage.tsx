...
const ChatPage = () => {
  ...
  const handleSendMessage = useCallback(
    async (content: string, image?: string) => {
      ...
      if (!currentSubjectId) {
        const res = await fetch(API_BASE, {
          ...
          body: JSON.stringify({ message: content, model, image }),
    ...
    [appendMessage, currentSubjectId, model, streamResponse]
  );
            ...
            {showBranding ? (
              <div className="h-full w-full grid place-items-center relative overflow-hidden">
                ...
                <div className="text-center select-none flex flex-col items-center">
                  ...
                  <p className="mt-2 text-md opacity-70">
